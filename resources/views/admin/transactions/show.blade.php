            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('admin/transactions' . '/' . $transaction->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Type </th><td> {{ $transaction->type }} </td></tr><tr><th> Amount </th><td> {{ $transaction->amount }} </td></tr><tr><th> User Id </th><td> {{ $transaction->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
